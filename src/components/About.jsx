  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        "Passionate about chess, cricket, and pop music. My fascination with the stock market and AI-driven quant finance blends my analytical curiosity, while my love for science, space, and spiritual wisdom fuels my quest for knowledge, shaping my perspective in both personal and professional endeavors."
